 ...
 * @width: get width.
 *
 * @precision: precision specifier parameter
 *
...
/**
 * write_num - functions that Write a number using a bufffer
 *
 ...
 *
 * @prec: Precision specifier parameter
 *
 * @length: Number length parameter
 *
 * @padd: Pading char paeamerer
 *
 * @extra_c: Extra char
 *
 ...
 *
 * @buffer: Array of chars parameters
 *
 * @flags: Flags specifiers prameter
 *
 * @width: Width specifier parameteer
 *
 * @precision: Precision specifier parameter
 *
 * @size: Size specifier parameter
